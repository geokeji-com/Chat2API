export const IpcChannels = {
  ...
  RPA_START_RECORDING: 'rpa:startRecording',
  RPA_START_AUTO_LEARNING: 'rpa:startAutoLearning',
  RPA_AUTO_LEARN_PROVIDER: 'rpa:autoLearnProvider',
  RPA_STOP_LEARNING: 'rpa:stopLearning',
  RPA_CANCEL_LEARNING: 'rpa:cancelLearning',
  RPA_GET_SESSION: 'rpa:getSession',
  RPA_GENERATE_REPORT: 'rpa:generateReport',
